...
<div class="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8">
    <div class="w-full lg:w-3/4 mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="max-h-96 overflow-y-auto space-y-3">
                        @if($supervisi->prosesPembelajaran)
                            @if($supervisi->prosesPembelajaran->video_link)
                                <div class="p-4 bg-linear-to-r from-red-50 to-pink-50 rounded-lg border border-red-100">
                                    <div class="flex items-start justify-between">
                            ...
                            @if($supervisi->prosesPembelajaran->meeting_link)
                                <div class="p-4 bg-linear-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1 min-w-0 pr-2">
                ...
                <div class="p-5">
                    ...
                    <div class="max-h-96 overflow-y-auto space-y-3">
                        @forelse($supervisi->feedback as $fb)
                            <div class="p-4 bg-linear-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-100">
                                <div class="flex items-start justify-between mb-2">
                                    ...
                                    @if($fb->is_revision_request)
                                        <span class="text-xs px-2 py-1 bg-rose-100 text-rose-700 dark:bg-rose-900 dark:text-rose-200 rounded-full font-medium">
                                            Revisi Diminta
                                        </span>
                                    @endif
                                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 dark:border-gray-700 p-6 mb-6">
            <h3 class="text-xl font-bold text-slate-800 dark:text-white mb-4">Berikan Feedback</h3>
            
            <form action="{{ route('kepala.evaluasi.feedback', $supervisi->id) }}" method="POST" class="space-y-4">
                @csrf
                
                <div>
                    <label for="komentar" class="block text-sm font-medium text-slate-700 dark:text-gray-200 mb-2">
                ...
                <div class="flex items-center">
                    <input 
                        ...
                        id="mark_completed" 
                        value="1"
                        class="w-4 h-4 text-indigo-600 dark:text-indigo-400 bg-gray-100 dark:bg-gray-700 border-gray-300 rounded focus:ring-indigo-500 focus:ring-2"
                    >
                    <label for="mark_completed" class="ml-2 text-sm font-medium text-slate-700 dark:text-gray-200">
                        Tandai sebagai "Telah Ditinjau" setelah memberikan feedback
                    </label>
                </div>

                <div class="flex items-center justify-between pt-6 mt-8 border-t border-slate-200 dark:border-gray-700">
