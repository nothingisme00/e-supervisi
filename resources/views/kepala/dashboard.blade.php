    ...
    <div class="pb-6 mb-6 border-b border-gray-200 dark:border-gray-700">
        ...
        <div class="flex flex-row items-center justify-between gap-3 md:gap-5 w-full">
                    ...
                    <div class="flex items-center gap-2 md:gap-4 flex-shrink min-w-0">
                        <div class="w-10 h-10 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-r from-violet-600 to-purple-600 dark:from-violet-500 dark:to-purple-500 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                        ...
                        <div class="min-w-0 flex-1">
                            <h3 class="text-base md:text-xl lg:text-2xl font-bold text-gray-900 dark:text-gray-100 truncate">Supervisi Pembelajaran</h3>
                            <p class="text-xs md:text-sm text-gray-500 dark:text-gray-400 hidden sm:block">Monitor dan evaluasi supervisi guru</p>
                        </div>
                    </div>
