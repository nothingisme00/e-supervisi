{{--
    Ikon SVG inline satu keluarga (gaya Heroicons outline, 24x24, stroke-width 1.5).
    Sumber tunggal ikon untuk seluruh aplikasi — jangan tempel SVG mentah di view lain.
    ...
    check-circle, x-mark, plus, search, users, pencil, trash, home, inbox, check.
--}}
@props(['name'])
