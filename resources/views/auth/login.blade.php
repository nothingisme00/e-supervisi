...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 min-h-screen">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <!-- Login Card -->
            <div class="bg-white shadow-2xl rounded-xl p-8 space-y-6 animate-fade-in">
                <div class="text-center">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="password" 
                               ...
                               placeholder="••••••••"
                               class="appearance-none block w-full px-4 py-3 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm transition-all @error('password') border-red-500 @else border-gray-300 @enderror">
