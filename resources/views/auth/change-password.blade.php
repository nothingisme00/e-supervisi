...
<body class="antialiased">
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4 py-12 relative">
        ...
        <div class="absolute top-4 right-4 flex items-center gap-3 z-10">
            ...
            <button onclick="toggleDarkMode()"
                    class="p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all shadow-sm">
    ...
    function updateThemeIcon() {
        ...
        // Check current theme
        if (localStorage.theme === 'dark' || (!('theme' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
            // Currently dark mode, show moon icon (to switch to light)
            darkIcon.classList.remove('hidden');
            lightIcon.classList.add('hidden');
        } else {
            // Currently light mode, show sun icon (to switch to dark)
