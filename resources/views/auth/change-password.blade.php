    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4 py-12 relative">
        ...
        <div class="w-full max-w-md">
            ...
            <form method="POST" action="{{ route('change-password.update') }}" id="changePasswordForm">
                ...
                <!-- Divider -->
                <div class="border-t border-gray-200 dark:border-gray-700 mt-8 mb-6"></div>

                <!-- Theme Toggle & Logout Section -->
                <div class="flex items-center gap-3">
                    <!-- Dark Mode Toggle -->
                    <button onclick="toggleDarkMode()"
                            class="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all text-sm font-medium">
                        ...
                        <span class="theme-label-light">Mode Gelap</span>
                        <span class="theme-label-dark hidden">Mode Terang</span>
                    </button>
                    ...
                    <form action="{{ route('logout') }}" method="POST" class="flex-1">
                        @csrf
                        <button type="submit"
                                class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white text-sm font-medium transition-all shadow-sm">
