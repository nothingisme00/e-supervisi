...
@php
    // Susunan entri disengaja: kunci payload yang kebetulan berbunyi seperti
    // label status ('revisi', 'review') dijauhkan dari baris kelas bg-*-100
    // agar tidak tersambar heuristik jendela-5-baris StatusPillSingleSourceTest
    // (ini chip ikon notifikasi, bukan pill status).
    $map = [
        'revisi' => [
